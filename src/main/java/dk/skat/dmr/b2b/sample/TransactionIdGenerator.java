...
public class TransactionIdGenerator {
     ...
     *
     * If JVM parameter -Ddk.skat.dmr.b2b.sample.TXID_PREFIX=SOMETHING has been set generated transaction
    ...
    public static final String getTransactionId() {
        final String prefix = System.getProperty("dk.skat.dmr.b2b.sample.TXID_PREFIX");
